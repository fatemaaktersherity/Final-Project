        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepreciationRatePercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    ...
                    NextDepreciationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LiabilityDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyLiabilities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_LedgerAccount_DebitXorCredit", "([DebitAmount] > 0 AND [CreditAmount] = 0) OR ([CreditAmount] > 0 AND [DebitAmount] = 0)");
                    table.ForeignKey(
                        name: "FK_LedgerAccounts_ChartOfAccounts_ChartOfAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Distributor = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariants_DosageForms_DosageFormId",
                        column: x => x.DosageFormId,
                        principalTable: "DosageForms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductVariants_ProductGroups_ProductGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiptImageContentType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentTitle = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PaidNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Allopathic"),
                    CompanyId = table.Column<int>(type: "int", nullable: true),
                    ...
                    ProductImageContentType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    RegisteredDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: true),
                    StockQuantity = table.Column<int>(type: "int", nullable: false),
                    MinStockQty = table.Column<int>(type: "int", nullable: false),
                    MaxStockQty = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SalePayment_Amount", "[Amount] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleId = table.Column<int>(type: "int", nullable: false),
                    ReturnTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxOrOthers = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PaymentStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsSupplierWise = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ReceiptImagePath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ReceiptImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    ReceiptImageContentType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
            ...
            migrationBuilder.CreateTable(
                name: "DailyPurchaseRequirements",
                columns: table => new
                {
                    SerialNo = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    OrdersQty = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyPurchaseRequirements", x => x.SerialNo);
                    table.ForeignKey(
                        name: "FK_DailyPurchaseRequirements_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DailyPurchaseRequirements_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DarNo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    PregnancyCategory = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    PriceType = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    UnitId = table.Column<int>(type: "int", nullable: true),
                    SupplierId = table.Column<int>(type: "int", nullable: true),
                    PreviousPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    NewPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PreviousBaseQuantity = table.Column<decimal>(type: "decimal(18,4)", nullable: true),
                    NewBaseQuantity = table.Column<decimal>(type: "decimal(18,4)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductPriceHistories_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "SupplierId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductPriceHistories_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerUnitPrice = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    ...
                    DistributorPrice = table.Column<decimal>(type: "decimal(18,4)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductRaks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductRaks_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductRaks_Warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceivingQty = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    IsCancelled = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastPurchaseUnitCost = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    LastPurchaseUnitId = table.Column<int>(type: "int", nullable: true),
                    Note = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupplierProducts_Units_LastPurchaseUnitId",
                        column: x => x.LastPurchaseUnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleReturnItems_Products_MedicineId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleReturnItems_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SaleReturnRefund_Amount", "[Amount] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DueBeforePayment = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PrePaid = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PaidAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierPaymentDetails_PurchaseInvoices_PurchaseInvoiceId",
                        column: x => x.PurchaseInvoiceId,
                        principalTable: "PurchaseInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    WarehouseId = table.Column<int>(type: "int", nullable: false),
                    ProductRakId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductStocks_ProductRaks_ProductRakId",
                        column: x => x.ProductRakId,
                        principalTable: "ProductRaks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductStocks_PurchaseInvoices_PurchaseInvoiceId",
                        column: x => x.PurchaseInvoiceId,
                        principalTable: "PurchaseInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ProductStocks_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "SupplierId",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierProductPrices_SupplierProducts_SupplierProductId",
                        column: x => x.SupplierProductId,
                        principalTable: "SupplierProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupplierProductPrices_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseReturnItems_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseReturnReceives", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchaseReturnReceives_PurchaseReturns_PurchaseReturnId",
                        column: x => x.PurchaseReturnId,
                        principalTable: "PurchaseReturns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpiredProductStocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpiredProductStocks_AppUsers_ApprovedByUserId",
                        column: x => x.ApprovedByUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExpiredProductStocks_ProductStocks_ProductStockId",
                        column: x => x.ProductStockId,
                        principalTable: "ProductStocks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExpiredProductStocks_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExpiredProductStocks_Warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SaleItem_Quantity", "[Quantity] > 0");
                    table.ForeignKey(
                        name: "FK_SaleItems_ProductStocks_ProductStockId",
                        column: x => x.ProductStockId,
                        principalTable: "ProductStocks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicineId = table.Column<int>(type: "int", nullable: false),
                    SourceProductStockId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockTransferItems_ProductStocks_ProductStockId",
                        column: x => x.ProductStockId,
                        principalTable: "ProductStocks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StockTransferItems_Products_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyPurchaseRequirements_ProductId",
                table: "DailyPurchaseRequirements",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_DailyPurchaseRequirements_UnitId",
                table: "DailyPurchaseRequirements",
                column: "UnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpiredProductStocks_ApprovedByUserId",
                table: "ExpiredProductStocks",
                column: "ApprovedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpiredProductStocks_ProductId",
                table: "ExpiredProductStocks",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpiredProductStocks_ProductStockId",
                table: "ExpiredProductStocks",
                column: "ProductStockId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpiredProductStocks_WarehouseId",
                table: "ExpiredProductStocks",
                column: "WarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_LedgerAccounts_ChartOfAccountId_TransactionDate",
                table: "LedgerAccounts",
                columns: new[] { "ChartOfAccountId", "TransactionDate" });

            migrationBuilder.CreateIndex(
                name: "IX_LedgerAccounts_VoucherNo",
                table: "LedgerAccounts",
                column: "VoucherNo");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPriceHistories_SupplierId_ProductId_ChangedAt",
                table: "ProductPriceHistories",
                columns: new[] { "SupplierId", "ProductId", "ChangedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ProductPriceHistories_UnitId",
                table: "ProductPriceHistories",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductPrices_ProductId_UnitId_DisplayName",
                table: "ProductPrices",
                columns: new[] { "ProductId", "UnitId", "DisplayName" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRaks_ProductId",
                table: "ProductRaks",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductRaks_WarehouseId",
                table: "ProductRaks",
                column: "WarehouseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductStocks_ProductId_BatchNumber",
                table: "ProductStocks",
                columns: new[] { "ProductId", "BatchNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductStocks_ProductRakId",
                table: "ProductStocks",
                column: "ProductRakId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductStocks_PurchaseInvoiceId",
                table: "ProductStocks",
                column: "PurchaseInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductStocks_SupplierId",
                table: "ProductStocks",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_DosageFormId",
                table: "ProductVariants",
                column: "DosageFormId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_ProductGroupId_Strength_DosageFormId",
                table: "ProductVariants",
                columns: new[] { "ProductGroupId", "Strength", "DosageFormId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReturnItems_UnitId",
                table: "PurchaseReturnItems",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReturnReceives_PurchaseReturnId",
                table: "PurchaseReturnReceives",
                column: "PurchaseReturnId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleItems_ProductStockId",
                table: "SaleItems",
                column: "ProductStockId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleReturnItems_UnitId",
                table: "SaleReturnItems",
                column: "UnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransferItems_ProductStockId",
                table: "StockTransferItems",
                column: "ProductStockId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierPaymentDetails_PurchaseInvoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierPayments_PaidNo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierProductPrices_SupplierProductId_UnitId",
                table: "SupplierProductPrices",
                columns: new[] { "SupplierProductId", "UnitId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SupplierProductPrices_UnitId",
                table: "SupplierProductPrices",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierProducts_LastPurchaseUnitId",
                table: "SupplierProducts",
                column: "LastPurchaseUnitId");
